        ...
        <header>
          ...
          <nav className="navbar fixed-top navbar-expand-lg navbar-light bg-light">
            <div className="container">
              {/* LOGO */}
              <a className="navbar-brand" href="index.html"><img src="images/logo.png" alt="logo header" /></a>
              ...
              <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav mr-auto">
                  <li className="nav-item active dropdown">
                    <a className="nav-link" href="index.html" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      Home
                    </a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" href="#whatinside">What's Inside?</a>
                  </li>
                  <li className="nav-item">
                ...
                <div className="order button gradient d-md-none d-sm-none d-xl-block d-lg-block">
                  <a href="src/checkout.js"><i className="fas fa-shopping-cart" />Order Gift Box</a>
                </div>{/* /.order */}
              </div>{/* /.collapse */}
            </div>{/* /.container */}
          </nav>
          ...
          <div className="row">
            <div className="col-12">
              ...
              <div className="order button gradient">
                <a href="index.html#pricing">Subscribe Now</a>
              </div>{/* /.order */}
            </div>
          </div>{/* /.row */}
        ...
        <section className="call-to-action-middle container">
          <div className="row justify-content-center">
            <div className="col-lg-5 col-xl-5 col-md-8">
              ...
              <div className="order button gradient">
                <a href="index.html#pricing">See Subscription Plans</a>
              </div>{/* /.order */}
            </div>
          </div>{/* /.row */}
        </section>{/* /.call-to-action */}
